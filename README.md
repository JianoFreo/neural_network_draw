...
The repository includes a full test suite demonstrating all features:

### Includes:

* Basic architecture drawing
* Full low-level API usage
* High-level API usage
* Weight visualization modes
* Bias-only visualizations
* Large input feature sets
* Regression-style networks
...
* Uses `matplotlib.use("Agg")` (headless mode)
* Saves diagrams as PNG files

Example:

```
Saved example_4_high_level_full_features.png
```

If you remove Agg mode:

* diagrams open in a window instead
* interactive matplotlib backend is used
